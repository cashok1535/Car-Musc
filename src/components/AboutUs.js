  ...
  return (
    <div className="aboutUs">
      <div className="aboutUs__left">
        <div className="aboutUs__left__element">
      ...
      <div className="aboutUs__right">
        <div className="aboutSlider">
          <div className="slider__line" ref={sliderRef}>
          ...
          <div className="aboutUs__sliderNavigation">
            <button className="aboutUs__left--button" onClick={handlePrev}>
            ...
            <button className="aboutUs__right--button" onClick={handleNext}>
              <img src={sliderButton} alt="" />
            </button>
          </div>
        </div>
